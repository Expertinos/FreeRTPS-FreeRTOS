...
void frudp_publish( frudp_pub_t *publication, frudp_submsg_data_t *submsg );
bool frudp_publish_user_msg( frudp_pub_t *publication, const uint8_t *msg, const uint32_t msg_len );
...
void frudp_pub_rx_acknack( frudp_pub_t *pub, frudp_submsg_acknack_t *acknack, frudp_guid_prefix_t *guid_prefix );

frudp_pub_t *frudp_create_user_pub( const char *topic_name, const char *type_name );
